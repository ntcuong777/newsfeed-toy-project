...
## Posts-1 `guestbook-post-page`

Add a page for a single post

## Posts 2 `guestbook-post-md`

Add markdown posts

## Posts 3 `guestbook-post-media`

Add media uploads to post composition form
